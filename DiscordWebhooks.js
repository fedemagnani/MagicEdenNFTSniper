...
class DiscordWebhooks {
    ...
    floorChanged(webhook, previousFloor, newFloor) {
        var title = newFloor > previousFloor ? `Floor raised ↑ to: ${newFloor} SOL` : `Floor decreased ↓ to: ${newFloor} SOL`
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setColor('#8f00ff')
            .addFields(
                { name: 'Old Floor', value: `${previousFloor}`, inline: false },
                { name: 'New Floor', value: `${newFloor}`, inline: false },
            )
            .setTimestamp()
        webhookClient.send({
            content: null,
